  ...
  if (accepted && !open) {
    return (
      <button
        ...
        className="fixed bottom-4 left-4 sm:left-6 z-[99999] p-3 rounded-full bg-slate-900/95 backdrop-blur-xl text-amber-400 border border-slate-800 shadow-2xl hover:bg-slate-800 transition-colors cursor-pointer"
      >
    ...
    <AnimatePresence>
      {showBanner && (
        <motion.div
          ...
          className="fixed bottom-4 left-4 sm:left-6 max-w-[calc(100vw-2rem)] sm:max-w-sm z-[99999]"
        >
